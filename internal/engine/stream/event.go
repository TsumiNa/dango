...
const (
	...
	EventAgentPolishStarted    = "agent.polish.started"
	EventAgentPolishCompleted  = "agent.polish.completed"
	EventAgentPolishFailed     = "agent.polish.failed"
	EventAgentExecuteStarted   = "agent.execute.started"
	EventAgentExecuteCompleted = "agent.execute.completed"
	EventAgentExecuteFailed    = "agent.execute.failed"
	EventAgentReportStarted    = "agent.report.started"
	EventAgentReportCompleted  = "agent.report.completed"
	EventAgentReportFailed     = "agent.report.failed"
